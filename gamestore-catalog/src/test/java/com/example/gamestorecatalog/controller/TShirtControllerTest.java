...
public class TShirtControllerTest{
        ...
        public void shouldCreateTShirt() throws Exception{
            ...
            when(tShirtRepository.save(inTShirt)).thenReturn(savedTShirt);
        ...
        public void shouldReturnTShirtInfo() throws Exception{
            ...
            // same as doReturn(gameViewModel).when(tShirtRepository).getGame(8);
            // We could also set up our mocks in a separate method, if we so chose
            when(tShirtRepository.findById(51L)).thenReturn(Optional.of(savedTShirt));
        ...
        public void shouldDeleteTShirt() throws Exception{
            ...
            //Nothing to mock!
            //Checking checking for the correct response status code
            doNothing().when(tShirtRepository).deleteById(51L);
        ...
        public void shouldGetTShirtByColor() throws Exception{
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAllByColor("SkyBlue")).thenReturn(foundList);
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAllByColor("non-existent color")).thenReturn(null);
        ...
        public void shouldGetTShirtBySize() throws Exception{
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAllBySize("S")).thenReturn(foundList);
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAllBySize("XL")).thenReturn(null);
        ...
        public void shouldGetAllTShirt() throws Exception{
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAll()).thenReturn(foundList);
            ...
            //Mock call to service layer...
            when(tShirtRepository.findAll()).thenReturn(null);
        ...
        public void shouldFailCreateTShirtWithBadData() throws Exception{
            ...
            //Mock call to service layer...
            when(tShirtRepository.save(inTShirt)).thenReturn(null);
        ...
        public void shouldFailUpdateTShirtWithBadData() throws Exception{
            ...
            //Nothing to mock!
            //Checking checking for the correct response status code
            //doNothing().when(tShirtRepository).save(inTShirt);
